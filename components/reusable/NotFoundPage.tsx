...
const NotFoundPage = () => {
  return (
    <div className='absolute top-0 left-0 w-screen h-screen flex justify-center bg-zinc-100 dark:bg-zinc-950 z-40 overflow-hidden'>
        <div className='absolute w-full h-full flex-center -z-10'>
          <h1 className='text-9xl scale-400 font-extrabold text-zinc-800 dark:text-zinc-400 font-archivo'>404</h1>
        </div>
        <TransitionLink href='/' className='absolute top-20'>
          <Button className="btn-large font-archivo">Back to Home Page</Button>
        </TransitionLink>
        <div className='absolute -bottom-4 w-full flex-col'>
          <div className='relative flex-center w-full h-28 pb-4'>
            ...
            <h1 className='text-zinc-950 dark:text-zinc-100 z-30 font-archivo'>The page you’re looking for is playing hide and seek. Spoiler: It won.</h1>
          </div>
