        ...
        <div className="relative py-24">
          <div className="relative w-full flex-center h-[60px]">
            ...
            <div className="absolute flex-center w-fit h-[80px] px-20">
              <svg className="absolute" width="100%" height="100%" id="dashed-x-one">
              ...
              <ShinyText text="Javascript Supremacy" disabled={false} speed={3} className='text-body-2-bold' />
            </div>
          </div>
          <div className="relative flex-center w-full h-[280px] mt-10 mb-5">
            <svg className="absolute" width="100%" height="100%" id="dashed-y-two">
              <line x1="0" y1="0" x2="100%" y2="0" className='stroke-current text-black dark:text-white' strokeWidth="1" strokeDasharray="9, 9" />
              <line x1="0" y1="100%" x2="100%" y2="100%" className='stroke-current text-black dark:text-white' strokeWidth="1" strokeDasharray="9, 9" />
            </svg>
            <div className="absolute px-20 w-full h-full flex-center">
              <div className="relative w-full h-full" id="dotted">
          ...
          <div className="text-center flex-center">
            <p className="text-body-2 flex gap-1" id="subtitle">Your Ultimate Hub for<span className="font-semibold">Web Development</span>Essentials.</p>
          </div>
          <div className="relative w-full h-[80px] mt-5">
            ...
            <div className="absolute top-0 left-0 w-full h-full flex-center gap-x-5" id="buttons">
              <Button className="btn-large font-archivo">Get Started</Button>
              <Button variant="outline" className="btn-large font-archivo">Discover</Button>
            </div>
          </div>
          <div className="absolute flex-center top-10 left-0 wrapper w-full h-[650px] -z-40 ">
            <div className="flex item-center w-full h-full px-20" id="dashed-x-two">
