    ...
    <div className="relative flex-center pt-32">
        ...
        <section className='flex flex-col items-center'>
            ...
            <div className='w-screen'>
                <div className='relative flex justify-center w-full h-fit py-20'>
                    <Image alt="" src={"/assets/images/inside_box_illu.png"} width={5000} height={5000} className="absolute h-full min-w-[120%] top-0 dark:invert rotate-180 dark:opacity-60" />
                    <Image alt="" src={"/assets/images/inside_box_illu.png"} width={5000} height={5000} className="absolute h-full min-w-[120%] top-0 dark:invert rotate-180 blur-sm opacity-40 hidden dark:block" />
                    ...
                    <div className='absolute flex flex-col -z-20 top-0 w-screen h-full'>
                        <div className='w-full h-20 bg-gradient-to-b from-transparent to-gray-300 dark:to-black'/>
                        <div className='w-full bg-gray-300 dark:bg-black flex-grow'/>
                        <div className='w-full h-20 bg-gradient-to-t from-transparent to-gray-300 dark:to-black'/>
                    </div>
                </div>
            </div>
            <div className="w-[600px] p-5">
                <div className='py-5'>
                    <h4 className='text-h6-bold'>About</h4>
                    <p className='font-normal font-archivo opacity-70'>I’m Mia Carter, a curious designer, coder, and storyteller. Currently a student at Springfield High School, but always exploring the limitless possibilities of creativity and technology. I thrive on transforming ideas into reality, whether it's crafting digital interfaces, designing immersive visuals, or building websites that feel effortless to use.</p>
                </div>
                <Separator/>
                <div className='py-5'>
                    <h6 className='text-h6-bold'>Work Experience</h6>
                    <div className='flex items-center'>
                        <p className='text-shadow w-44'>2021 - Present</p>
                        <p className='font-archivo'>Students enrolled in the Informatics study program</p>
                    </div>
                </div>
                <Separator/>
                <div className='py-10 flex flex-col gap-y-5'>
                    ...
                    <div className='w-full flex-center' >
                        <TransitionLink href='/resource/detail' >
                            <Button className='w-fit font-archivo px-10'>More Portfolio<PiArrowUpRight /></Button>
                        </TransitionLink>
                    </div>
                </div>
                <div className='relative py-5'>
                    <Image alt='' src={"/assets/images/bg_grid.png"} width={2000} height={2000} className='absolute top-32 w-full dark:invert dark:opacity-50 -z-30'/>
                    <div className='flex flex-col gap-y-3 pb-5'>
                        <h6 className='text-h6-bold text-center' >How Can I Help?</h6>
                        <p className='text-body-2 text-center'>Let's transform your imagination into something<br/>delightful.</p>
                    </div>
                    <div className='p-5 flex-center flex-wrap gap-2'>
                        <Card className='w-[49%]'>
                            <CardContent className='flex flex-col gap-y-2 p-4'>
                                ...
                                <p className='text-body-2 opacity-60'>Designing visually stunning, user-friendly layouts and interfaces to enhance the digital experience.</p>
                            </CardContent>
                        </Card>
                        <Card className='w-[49%]'>
                            <CardContent className='flex flex-col gap-y-2 p-4'>
                                ...
                                <p className='text-body-2 opacity-60'>Developing complete web solutions, from backend services to polished frontend experiences.</p>
                            </CardContent>
                        </Card>
                        <Card className='w-[49%]'>
                            <CardContent className='flex flex-col gap-y-2 p-4'>
                                ...
                                <p className='text-body-2 opacity-60'>Creating dynamic and responsive web interfaces that prioritize user interaction and experience.</p>
                            </CardContent>
                        </Card>
                        <Card className='w-[49%]'>
                            <CardContent className='flex flex-col gap-y-2 p-4'>
                                ...
                                <p className='text-body-2 opacity-60'>Building robust and efficient server-side logic, APIs, and database management systems.</p>
                            </CardContent>
                        </Card>
                    </div>
                </div>
